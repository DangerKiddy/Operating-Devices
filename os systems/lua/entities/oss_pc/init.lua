...
include('shared.lua')
	...
	function ENT:Touch(ent)
		if ent.OSS_IsMonitor and not ent.OSS_Connected and not self.OSS_HasMonitor then
			...
			constraint.Rope(self,ent,0,0,Vector(-9.9, -1.5, -4.2),Vector(-13.1, -3.9, 0.5),1,140,0,2,"cable/cable2",false)
		...
		elseif ent.OSS_IsKeyboard and not ent.OSS_Connected and not self.OSS_HasKeyboard then
			...
			constraint.Rope(self,ent,0,0,Vector(-9.9, -1.5, -4.2),Vector(-3.2, 8.6, 2.4),1,140,0,2,"cable/cable2",false)
			ent.OSS_Connected = true
			ent.OSS_ConnectedENT = self
		...
		elseif ent:GetClass() == "oss_printer" and not self.OSS_HasPrinter and not ent.OSS_ConnectedENT then
			constraint.Rope(self,ent,0,0,Vector(-9.9, -1.5, -4.2),Vector(-16.384344, -6.078898, 3.805751),1,140,0,2,"cable/cable2",false)
